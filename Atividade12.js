...
// → Seu código aqui:
//  const cidades = ["jaragua do sul", "Guaramirim", "Scheroeder", "joinville", "Blumenau",];
...
// console.log("Quantidade total de cidades:",[cidades.length - 1]); 

// console.log("Total das cidades:", cidades.length);
...
//   }
// }
// console.log(`Maior TEMPERATURA : ${maior} Menor TEMPERATURA : ${menor}`);
