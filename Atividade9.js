...
//     contadorPares++;
// }
// console.log(`Quantidade de numero pares exibidos : ${contadorPares}`);
// console.log("_______________________________");
...
// let numero = lerTeclado.questionInt("Digite um numero pra ver sua tabuada:");
// for(let i = 1; i <= 10;i ++){
...
// → Seu código aqui:
// const N = lerTeclado.questionInt("Digite um numero inteiro positivo:")
// let soma = 0;
// for (let i = 1; i <= N; i++) {
//     soma += i;
// }
