...
// let idade = lerTeclado.questionInt("Qual a sua idade?")
// if(idade >= 18){
//     console.log("Adulto")
// } else if (idade < 12){
//     console.log("Criança")
...
//     console.log(`${motorista.nome} Você pode alugar um carro.`);
// } else {
//     console.log(`${motorista.nome} Você não pode alugar um carro.`)
// }
console.log("_______________________________");
